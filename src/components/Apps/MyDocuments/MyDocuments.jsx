...
const DOCUMENTS = [
  { id: "resume", icon: "📝", label: "Resume.doc", type: "Microsoft Word Document", size: "24 KB" },
  { id: "budget", icon: "📊", label: "Budget_98.xls", type: "Microsoft Excel Spreadsheet", size: "42 KB" },
  { id: "todo", icon: "📋", label: "TODO.txt", type: "Text Document", size: "1 KB" },
  { id: "photos", icon: "📁", label: "My Pictures", type: "File Folder", size: "—" },
];
...
function ExplorerItem({ item, viewMode, selected, onSelect }) {
  ...
  return (
    <div style={style} onClick={onSelect}>
      <span style={{ fontSize: viewMode === "icons" ? 28 : 16 }}>{item.icon}</span>
