...
const DRIVES = [
  { id: "floppy", icon: "💾", label: "3½ Floppy (A:)",  type: "Floppy Disk",   size: "1.44 MB" },
  { id: "c",      icon: "🖥️", label: "Local Disk (C:)", type: "Local Disk",    size: "2.00 GB" },
  { id: "d",      icon: "💿", label: "CD-ROM (D:)",     type: "CD-ROM Drive",  size: "—" },
];

const SYS_FOLDERS = [
  { id: "ctrl",     icon: "🎛️", label: "Control Panel" },
  { id: "printers", icon: "🖨️", label: "Printers" },
  { id: "dial",     icon: "📞", label: "Dial-Up Networking" },
];
